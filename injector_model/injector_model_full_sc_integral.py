...
class InjectorChain_full_SC_integral:
    """
    Representation of the CERN Injector Chain for different ions, solving
    for maximum tune shift from full space charge integral
    """
