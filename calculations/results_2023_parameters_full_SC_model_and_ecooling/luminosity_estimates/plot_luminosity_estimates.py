...
ax.bar(x - 0.5 * bar_width, df_AA['2024 conservative'], bar_width, color='blue', label='Conservative') #
ax.bar(x + 0.5 * bar_width, df_AA['2024 optimistic'], bar_width, color='lime', label='Optimistic') #
ax.bar(x + 1.5 * bar_width, df_AA['2024 25 ns'], bar_width, color='darkorange', label='25 ns') #
ax.set_xticks(x)
...
ax2.bar(x - 0.5 * bar_width, df_NN['2024 conservative'], bar_width, color='blue', label='Conservative') #
ax2.bar(x + 0.5 * bar_width, df_NN['2024 optimistic'], bar_width, color='lime', label='Optimistic') #
ax2.bar(x + 1.5 * bar_width, df_NN['2024 25 ns'], bar_width, color='darkorange', label='25 ns') #
ax2.set_xticks(x)
