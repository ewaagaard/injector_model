...
def calculate_LHC_intensities_all_scenarios_vary_charge_state(
    ...
    df1_all_LEIR_charge_states.T.to_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_1, ecool_str))
    df2_all_LEIR_charge_states.T.to_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_2, ecool_str))
    df3_all_LEIR_charge_states.T.to_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_3, ecool_str))
    df4_all_LEIR_charge_states.T.to_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_4, ecool_str))
