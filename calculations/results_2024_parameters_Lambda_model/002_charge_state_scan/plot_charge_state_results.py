...
def read_charge_scan_results(ion_type, output_extra_str, count, stripped):
    ...
    df1 = pd.read_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_1, ecool_str), index_col=0)
    df2 = pd.read_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_2, ecool_str), header=None, index_col=0)
    df3 = pd.read_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_3, ecool_str), header=None, index_col=0)
    df4 = pd.read_csv("output/charge_scan_results/{}_{}{}.csv".format(ion_type, output_4, ecool_str), header=None, index_col=0)
