...
def calculate_LHC_intensities_all_scenarios_vary_isotope(
    ...
    injector_chain1 = InjectorChain(PS_splitting = 2,
                                    account_for_LEIR_ecooling=account_for_LEIR_ecooling,
                                    PS_factor_SC = np.inf if not consider_PS_SC_limit else 1.0
                                    )
    ...
    df1_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}_{}.csv".format(ion_type, output_1, ecool_str))
    df2_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}_{}.csv".format(ion_type, output_2, ecool_str))
    df3_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}_{}.csv".format(ion_type, output_3, ecool_str))
    df4_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}_{}.csv".format(ion_type, output_4, ecool_str))
