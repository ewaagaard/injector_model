...
df1 = pd.read_csv('../{}/output_csv/1_baseline.csv'.format(load_string), index_col=0).T
df2 = pd.read_csv('../{}/output_csv/2_no_PS_splitting.csv'.format(load_string), index_col=0).T
df3 = pd.read_csv('../{}/output_csv/3_LEIR_PS_stripping.csv'.format(load_string), index_col=0).T
df4 = pd.read_csv('../{}/output_csv/4_no_PS_splitting_and_LEIR_PS_stripping.csv'.format(load_string), index_col=0).T
...
fig7.savefig('5_scenarios_with_best_charge_states_and_isotopes{}.png'.format(output_extra_str), dpi=250)
plt.close()