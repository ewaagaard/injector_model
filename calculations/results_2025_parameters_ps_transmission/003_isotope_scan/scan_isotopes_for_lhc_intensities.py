...
def calculate_LHC_intensities_all_scenarios_vary_isotope(
    ...
    df1_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}{}_ps_rest_gas.csv".format(ion_type, output_1, ecool_str))
    df2_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}{}_ps_rest_gas.csv".format(ion_type, output_2, ecool_str))
    df3_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}{}_ps_rest_gas.csv".format(ion_type, output_3, ecool_str))
    df4_all_isotopes.T.to_csv("output/isotope_scan_results/{}_{}{}_ps_rest_gas.csv".format(ion_type, output_4, ecool_str))
